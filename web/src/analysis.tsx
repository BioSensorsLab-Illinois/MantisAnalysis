...
// analysis-page-overhaul-v1 Phase 8 final: legacy *AnalysisModal bodies +
// dispatcher deleted (~1620 lines). The new `<AnalysisShell>` in
// `web/src/analysis/shell.tsx` is now the only mount; app.tsx imports it
// directly. The `_*TabBody` bridges still exist so the new mode files can
// dispatch into the chart components that still live here. Future phases
// move chart bodies into `web/src/analysis/charts/` and retire the bridges.
export {
  _USAFTabBody,
  _FPNTabBody,
  _DoFTabBody,
